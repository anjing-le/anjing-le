...
<title id="title">Happy LLM Journey：知识、实践方法、活动</title>
<desc id="desc">知识支撑方法，方法指导活动，活动反馈持续修正方法与知识。</desc>
<style>text{font-family:"Chalkboard SE","Comic Sans MS","PingFang SC","Microsoft YaHei",sans-serif;fill:#10212e}.label{font-size:28px;font-weight:800}.sub{font-size:18px;fill:#61707d}.line{stroke:#10212e;stroke-width:3.5;fill:none;stroke-linecap:round;stroke-linejoin:round}
.bob{animation:journey-bob 2.4s ease-in-out infinite;transform-box:fill-box;transform-origin:center}
.flow{animation:journey-flow 1.8s linear infinite}
.feedback{stroke-dasharray:7 9;animation:journey-feedback 2.4s linear infinite}
@keyframes journey-bob{0%,100%{transform:translateY(0)}50%{transform:translateY(-6px)}}
@keyframes journey-flow{to{stroke-dashoffset:-28}}
@keyframes journey-feedback{to{stroke-dashoffset:-32}}
@media(prefers-reduced-motion:reduce){.bob,.flow,.feedback{animation:none!important}}
</style>
...
<text x="74" y="122" class="sub">Happy LLM Journey · 把理解变成方法，在实践中持续打磨</text>
<path class="flow" d="M363 221 H423 M753 221 H813" stroke="#a0aab5" stroke-width="4" stroke-dasharray="6 8"/>
<path d="M413 214 L423 221 L413 228 M803 214 L813 221 L803 228" fill="none" stroke="#a0aab5" stroke-width="3"/>
<g transform="translate(74 158)"><g class="bob" style="animation-delay:-0.0s">
...
<g transform="translate(444 158)"><g class="bob" style="animation-delay:-0.4s">
...
<g transform="translate(814 158)"><g class="bob" style="animation-delay:-0.8s">
...
<path class="feedback" d="M958 281 V307 H222 V283 M215 291 L222 283 L229 291" stroke="#b4a5ce" stroke-width="2.5" fill="none" stroke-linejoin="round"/>
